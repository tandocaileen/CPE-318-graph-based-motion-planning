...
ans = int(input("Enter grid size (square) ::"))
ROWS = ans
COLUMNS = ans
messagebox.showinfo(master=None, message="-click the starting position\n"
                                         "-middle click additional obstacles u want to add "
                                         "\n-right click the goal position",title="INSTRUCTIONS")
